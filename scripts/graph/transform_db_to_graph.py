...
def plot_graph(graph, node_color=None):
    ...
    nx.draw_networkx(graph, pos=pos, node_size=5, with_labels=False, node_color=node_color, font_size=6)
...
def get_hyperlane_edges(db_path) -> List[tuple]:
    hyperlanes = json.load(open(db_path))
...
if __name__ == "__main__":
    ...
    hyperlanes = get_hyperlane_edges(hyperlanes_path)
